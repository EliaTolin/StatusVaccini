...
abstract class URLConst {
  ...
  static Uri anagraficaVacciniSummaryLatest = new Uri(
      path:
  ...
  static Uri consegneVacciniLatest = new Uri(
      path:
  ...
  static Uri somministrazioneVacciniLatest = new Uri(
      path:
  ...
  static Uri sommistrazioneVacciniSummaryLatest = new Uri(
      path:
  ...
  static Uri vacciniSummaryLatest = new Uri(
      path:
  ...
  static Uri lastUpdateDataSet = new Uri(
      path:
