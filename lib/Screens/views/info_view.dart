          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                //                    buymeacoffee.com/eliatolin
                InkWell(
                  splashColor: Colors.blue.withAlpha(30),
                  onTap: () async {
                    const url = 'https://buymeacoffee.com/eliatolin';
                    if (await canLaunch(url)) {
                      await launch(url);
                    } else {
                      throw 'Could not launch $url';
                  ...
                  child: Card(
                    shape: RoundedRectangleBorder(
                      borderRadius:
                          BorderRadius.circular(SVConst.radiusComponent),
                    ),
                            ...
                            children: <Widget>[
                                    ...
                                    AutoSizeText.rich(
                                      TextSpan(
                                        children: [
                                          TextSpan(
                                              text:
                                                  "Se trovi utile quest'applicazione e vuoi supportarci, clicca qui questo riguadro!"),
                                        ],
                                      ),
                                      textAlign: TextAlign.left,
                                      style: TextStyle(
                              ...
                              Container(
                                ...
                                child:
                                    ...
                                    // ),
                                    ImageIcon(
                                  AssetImage("assets/icons/buymecoffee.png"),
                                ),
                              ),
                            ],
                          ),
